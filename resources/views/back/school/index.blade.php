                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" action="{{ route('school.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <input class="form-control" name="address" id="address" required value="{{ old('address')}}">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><form class="delete" action="{{ route('school.destroy', $school->id) }}" method="POST">
                                            <a href="{{ route('school.edit', $school->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
