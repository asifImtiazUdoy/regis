                ...
                <div style="padding: 2px">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-primary" href="{{ route('download.pdf', $exhibitor->id)}}">Download <i class="fa fa-file-pdf-o"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" id="printarea">
                    ...
                    <div class="card-header" style="background: #fff; padding: 30px">
                        <div class="row">
                            <div class="col-2" style="display: flex; justify-content: center;">
                                <img src="{{ url('uploads/images', $setting->logo)}}" alt="{{ $setting->website_name }}" style="margin: auto; width: 100%;">
                            </div>
                            <div class="col-10">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="margin-bottom:0;">
                            <div class="col-md-4">
                                <center><a style="color: #444444" href="{{ $setting->website }}">{{ $setting->website }}</a></center>
                            </div>
                            <div class="col-md-4">
                                <center>{!! $setting->phone !!}</center>
                            </div>
                            <div class="col-md-4">
                                <center>{{ $setting->email }}</center>
                            </div>
                        </div>
                    </div>
                </div>
